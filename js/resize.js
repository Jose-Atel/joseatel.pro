document.addEventListener('DOMContentLoaded', function() {
    ...
    dropbtns.forEach(dropbtn => {
        ...
        dropdownContent.innerHTML = `
            <a href="#">Move</a>
            <a href="#" class="resize-link">Resize</a>
            <a href="#">Minimize</a>
        ...
        function handleOptionClick(option) {
            ...
            switch (option) {
                ...
                case 'Resize':
                    ...
                    enableResizeWindow(windowElement);
                    break;
                case 'Minimize':
        ...
        // Función para activar el redimensionamiento de la ventana
        function enableResizeWindow(windowElement) {
            ...
            function startResizeWindow(event) {
                event.preventDefault();
                const initialMouseX = event.clientX;
                const initialMouseY = event.clientY;
                const initialWidth = parseInt(window.getComputedStyle(windowElement).width, 10);
                const initialHeight = parseInt(window.getComputedStyle(windowElement).height, 10);
        ...
        // Evitar que se cierre el menú al hacer clic en el enlace Maximize
